...
from apigee import (
  APIGEE_CLI_PLUGIN_INFO_FILE, APIGEE_CLI_PLUGIN_INFO_FILE_LEGACY, APIGEE_CLI_PLUGINS_CONFIG_FILE, APIGEE_CLI_PLUGINS_DIRECTORY, APIGEE_CLI_PLUGINS_PATH,
  console
)
from apigee.silent import common_silent_options
from apigee.utils import (create_directory, create_empty_file, execute_function_on_directory_files, is_directory, is_regular_file, read_file_content)
...
class PluginManager:
    ...
    def print_latest_commit(name):
        ...
        console.echo(repo.git.log("--pretty=format:%Cred%h%Creset -%C(yellow)%d%Creset %s "
