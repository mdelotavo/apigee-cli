...
class ApiPullerWithDependencyExtraction:
    ...
    def keyvaluemaps_dir(self, value):
        self._keyvaluemaps_dir = str(
            Path(self._working_directory) / value / self.environment)
    ...
    def export_resource_dependencies_using_getattr(self,
                                                   resource_type,
                                                   files,
                                                   environment,
                                                   force=True):
        resource_files = getattr(self,
                                 f"get_{resource_type}_dependencies")(files)
        getattr(self, f"export_{resource_type}_dependencies")(environment,
                                                              resource_files,
                                                              force=force)
