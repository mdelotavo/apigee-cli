...
class Apps:
    ...
    def create_a_consumer_key_and_secret(
      ...
      products=[],
        ...
        if products:
            ...
            request_body = json.dumps({"apiProducts": products, "attributes": resp.json()["attributes"]})
    ...
    def create_developer_app(self, developer, request_body):
        ...
        uri = CREATE_DEVELOPER_APP_PATH.format(api_url=APIGEE_ADMIN_API_URL, org=self.org_name, developer=developer)
        hdrs = auth.set_authentication_headers(
          self.auth,
          custom_headers={
            "Accept": "application/json",
    ...
    def create_empty_developer_app(self, developer, display_name="", callback_url=""):
        uri = CREATE_EMPTY_DEVELOPER_APP_PATH.format(api_url=APIGEE_ADMIN_API_URL, org=self.org_name, developer=developer)
        hdrs = auth.set_authentication_headers(
          self.auth,
          custom_headers={
            "Accept": "application/json",
    ...
    def list_developer_apps(
      ...
      format="json",
        ...
        uri = LIST_DEVELOPER_APPS_PATH.format(api_url=APIGEE_ADMIN_API_URL, org=self.org_name, developer=developer)
