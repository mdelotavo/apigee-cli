...
def _create_a_targetserver(username, password, mfa_secret, token, zonename, org, profile, name, environment, body, **kwargs):
    return (Targetservers(generate_authentication(username, password, mfa_secret, token, zonename), org, name).create_a_targetserver(environment, body).text)
...
def _delete_a_targetserver(username, password, mfa_secret, token, zonename, org, profile, name, environment, **kwargs):
    return (Targetservers(generate_authentication(username, password, mfa_secret, token, zonename), org, name).delete_a_targetserver(environment).text)
...
def _list_targetservers_in_an_environment(username, password, mfa_secret, token, zonename, org, profile, environment, prefix=None, **kwargs):
    return Targetservers(generate_authentication(username, password, mfa_secret, token, zonename), org,
...
def _get_targetserver(username, password, mfa_secret, token, zonename, org, profile, name, environment, **kwargs):
    return (Targetservers(generate_authentication(username, password, mfa_secret, token, zonename), org, name).get_targetserver(environment).text)
...
def _update_a_targetserver(username, password, mfa_secret, token, zonename, org, profile, name, environment, body, **kwargs):
    return (Targetservers(generate_authentication(username, password, mfa_secret, token, zonename), org, name).update_a_targetserver(environment, body).text)
...
def _push_targetserver(username, password, mfa_secret, token, zonename, org, profile, environment, file, **kwargs):
    return Targetservers(generate_authentication(username, password, mfa_secret, token, zonename), org, None).push_targetserver(environment, file)
